<template>
  <div>
    <div class="payer-form-group__note"><h3>Данные индивидуального предпринимателя</h3></div>
    <ValidationObserver ref="form">
      <div class="row">
        <div class="col-md-12">
          <DaDataSuggestion
              mode="INDIVIDUAL" label="Введите название в свободной форме, адрес, ИНН или ОГРН"  @dadata-select-suggestion="daDataSelectSuggestion">
          </DaDataSuggestion>
        </div>
      </div>
        ...
        <div class="row">
          <div v-for="field in fields">
            <div :class="field.class" >
              <FormField :name="field.label" :label="field.label" :rules="field.rules" v-model.trim="field.value"/>
            </div>
          </div>
        </div>
      </template>
  ...
  data: function () {
    return {
      ...
      fields: [
        ...
        {name: 'name_full_with_opf', label: 'Полное наименование', value: '', class: 'col-md-12', rules: 'required'},
